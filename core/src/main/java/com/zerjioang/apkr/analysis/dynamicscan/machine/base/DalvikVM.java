...
import com.zerjioang.apkr.analysis.dynamicscan.machine.base.constants.TypeDescriptorSemantics;
import com.zerjioang.apkr.analysis.dynamicscan.machine.base.exceptions.ChangeThreadRuntimeException;
import com.zerjioang.apkr.analysis.dynamicscan.machine.base.exceptions.MachineStateEndedException;
...
import com.zerjioang.apkr.analysis.dynamicscan.machine.base.struct.generic.*;
import com.zerjioang.apkr.analysis.dynamicscan.machine.reader.DexClassReader;
import com.zerjioang.apkr.analysis.emulator.AndroidLogEmulator;
import com.zerjioang.apkr.analysis.emulator.ReflectionEmulator;
...
public class DalvikVM extends AbstractVirtualMachine {
     ...
     * @param project
     */
    public DalvikVM(ApkrProject project) {
        this(null, project);
    }
     ...
     * @param project
     */
    public DalvikVM(String mainClassName, String[] argument, ApkrProject project) {
     ...
     * @param project
     */
    public DalvikVM(String mainClassName, ApkrProject project) {
        super(mainClassName, null, project);
        DexClassReader.init(this, project);
        systemClassLoader = DexClassReader.getInstance();
    }

    public void load(ApkrFile dex, byte[] bytes, boolean multidex) {
    ...
    public boolean handleConstructor(final IAtomFrame frame, final String absoluteClassName, final String methodName, final String methodDescriptor) throws Exception {
        ...
        System.out.println("\nUsed package name in that instruction was not implemented.\nPackage name: "+packageName+"\nClass name: "+className+"\nMethod name: "+methodName);
        replaceObjects(frame, frame.getObjectArguments()[0], new Object());
