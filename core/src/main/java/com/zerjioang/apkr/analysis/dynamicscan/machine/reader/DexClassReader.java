...
import com.zerjioang.apkr.analysis.dynamicscan.machine.base.constants.AccessFlag;
import com.zerjioang.apkr.analysis.dynamicscan.machine.base.constants.ValueFormat;
import com.zerjioang.apkr.analysis.dynamicscan.machine.base.exceptions.NotSupportedValueTypeException;
import com.zerjioang.apkr.analysis.dynamicscan.machine.base.struct.fake.DVMTaintClass;
import com.zerjioang.apkr.analysis.dynamicscan.machine.base.struct.fake.DVMTaintField;
import com.zerjioang.apkr.analysis.dynamicscan.machine.base.struct.fake.EncapsulatedClass;
...
import com.zerjioang.apkr.analysis.dynamicscan.machine.base.struct.model.DVMClass;
import com.zerjioang.apkr.analysis.dynamicscan.machine.base.struct.model.DVMField;
import com.zerjioang.apkr.analysis.dynamicscan.machine.base.struct.model.DVMMethod;
import com.zerjioang.apkr.analysis.dynamicscan.machine.base.struct.model.SharedPool;
...
public final class DexClassReader implements Serializable {
    ...
    private DexClassReader(DalvikVM dalvikVM, ApkrProject currentProject) {
        super();
        this.vm = dalvikVM;
    ...
    public static DexClassReader init(DalvikVM dalvikVM, ApkrProject currentProject) {
        if (instance == null)
    ...
    private EncapsulatedClass buildFakeClss(String name, Object newInstance) {
        ...
        newClass.setJavaObject(newInstance);
        newClass.setSuperClass(ApkrConstants.SUPERCLASS);
        return newClass;
    }
    ...
    public void loadClasses(final byte[] dexFileContent, boolean multidex) {
        ...
        currentProject.addDexInfo(this);
    }
        ...
        if (offset != 0) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (hasNoValue(superClassIndex)) {
                    cls.setSuperClass(ApkrConstants.SUPERCLASS);
                } else {
