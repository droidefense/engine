...
import com.zerjioang.apkr.analysis.dynamicscan.machine.base.struct.model.DVMFrame;
...
public abstract strictfp class AbstractDVMThread implements Serializable {
    ...
    protected static Instruction[] instructions = Instruction.values();
    ...
    public AbstractDVMThread(final DalvikVM vm, final ApkrProject currentProject) {
        this.vm = vm;
    ...
    public strictfp void execute(final boolean endless) throws Throwable {
        ...
        while (endless || 0 < count--) {
            try {
                ...
                System.out.println("Instruction: 0x" + Integer.toHexString(instVal).toUpperCase());
                InstructionReturn returnValue = instructions[instVal].execute(null, this, lowerCodes, upperCodes, codes, Instruction.REAL_EXECUTION);
                if (returnValue != null) {
