...
public class DexFileStatistics implements Serializable {
    ...
    private transient final ArrayList<ApkrFile> list;
    ...
    public DexFileStatistics(ApkrProject currentProject, ArrayList<ApkrFile> list) {
        //create VM
    ...
    private void process(ApkrFile dexFile) {
