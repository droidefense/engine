...
import com.zerjioang.apkr.v1.common.datamodel.certificate.CertificateSubject;
...
import com.zerjioang.apkr.v1.core.analysis.sttc.parser.AndroidCertParser;
    ...
    public void onTask() {
        ...
        if (cont) {
            for (int i = 0; i < files.size(); i++) {
                ...
                handler.doTheJob();
                ArrayList<ResourceFile> certs = handler.getFiles();
                for (ResourceFile r : certs) {
