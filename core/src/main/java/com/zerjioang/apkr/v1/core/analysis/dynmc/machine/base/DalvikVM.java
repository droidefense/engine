...
import com.zerjioang.apkr.v1.core.emulator.AndroidLogEmulator;
import com.zerjioang.apkr.v1.core.emulator.ReflectionEmulator;
...
public class DalvikVM extends AbstractVirtualMachine {
    ...
    public void load(ResourceFile dex, byte[] bytes, boolean multidex) {
