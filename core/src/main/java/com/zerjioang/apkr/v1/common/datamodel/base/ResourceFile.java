...
public class ResourceFile implements Serializable {
    ...
    public ResourceFile(String apkPath, boolean generateInformation) {
        this(new File(apkPath), generateInformation);
    }

    public ResourceFile(File parent, boolean generateInformation) {
        this.f = parent;
        if (this.f.isFile()) {
    ...
    public ResourceFile(File parent) {
        this(parent, true);
    }
