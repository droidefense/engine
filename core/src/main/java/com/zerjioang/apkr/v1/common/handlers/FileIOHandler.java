package com.zerjioang.apkr.v1.common.handlers;
...
public class FileIOHandler {
    ...
    public static File getUnpackOutputFile(ResourceFile source) {
        return new File(getUnpackOutputFile() + File.separator + source.getSha256());
    }

    public static InputStream getResourceFileInputStream(String name) throws FileNotFoundException {
    ...
    public static String getUnpackOutputPath(ResourceFile source) {
    ...
    public static byte[] readBytes(ResourceFile file) throws IOException {
