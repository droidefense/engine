...
import com.zerjioang.apkr.v2.helpers.system.OSDetection;
...
public class ObjdumpHandler extends AbstractHandler {
    ...
    private ArrayList<ResourceFile> list;
    ...
    public ArrayList<ResourceFile> getList() {
        return list;
    }

    public void setList(ArrayList<ResourceFile> list) {
        this.list = list;
    }
}
