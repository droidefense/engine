...
public enum AccessFlag implements Serializable {
    ...
    ACC_PUBLIC {
        ...
        public String getDescription() {
            return "public: visible everywhere	public: visible everywhere	public: visible everywhere";
        }
    ...
    ACC_PRIVATE {
        ...
        public String getDescription() {
            return "private: only visible to defining class	private: only visible to defining class	private: only visible to ";
        }
    ...
    ACC_PROTECTED {
        ...
        public String getDescription() {
            return "protected: visible to package and subclasses	protected: visible to package and subclasses	protected: ";
        }
    ...
    ACC_STATIC {
        ...
        public String getDescription() {
            return "static: is not constructed with an outer this reference	static: global to defining class	static: does not ";
        }
    ...
    ACC_FINAL {
        ...
        public String getDescription() {
            return "final: not subclassable	final: immutable after construction	final: not overridable";
        }
    ...
    ACC_SYNTHETIC {
        ...
        public String getDescription() {
            return "not directly defined in source code	not directly defined in source code	not directly defined in source code";
        }
    ...
    ACC_ENUM {
        ...
        public String getDescription() {
            return "declared as an enumerated type declared as an enumerated value";
        }
