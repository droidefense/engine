...
import com.zerjioang.apkr.v1.core.cfg.nodes.ConditionalNode;
...
public final strictfp class MultiFlowWorker extends AbstractDVMThread {

    private static AbstractFlowMap flowMap;
    private AbstractAtomNode fromNode;
    private AbstractAtomNode toNode;

    public MultiFlowWorker(ApkrProject project) {
