...
public enum ValueFormat implements Serializable {
    ...
    VALUE_BYTE {
        ...
        @Override
        public boolean setValue(IAtomField staticField, int valueArgument, DexClassReader2 loader) {
    ...
    public static ValueFormat getDataType(int valueType) {
        if (valMap.isEmpty()) {
            //map DalvikInstruction id with position of the enum array. Using this, I avoid 'for' searching
            valMap.put(0x00, 0);
            valMap.put(0x02, 1);
            valMap.put(0x03, 2);
            valMap.put(0x04, 3);
    ...
    public abstract boolean setValue(IAtomField staticField, int valueArgument, DexClassReader2 loader);
