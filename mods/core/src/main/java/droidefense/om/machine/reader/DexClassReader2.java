...
public final class DexClassReader2 implements Serializable {

    //set method shared pool. singleton
    private static SharedPool pool = SharedPool.getInstance();

    //Singleton class
    private static DexClassReader2 instance;
    ...
    private DexClassReader2(DalvikVM dalvikVM, DroidefenseProject currentProject) {
        super();
        this.vm = dalvikVM;
    ...
    public static DexClassReader2 init(DalvikVM dalvikVM, DroidefenseProject currentProject) {
        if (instance == null)
            instance = new DexClassReader2(dalvikVM, currentProject);
        return instance;
    }

    public static DexClassReader2 getInstance() {
        return instance;
    }
