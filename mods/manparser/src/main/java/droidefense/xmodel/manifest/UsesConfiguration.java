...
import droidefense.xmodel.manifest.enums.ReqNavigation;
import droidefense.xmodel.manifest.enums.ReqTouchScreen;
import droidefense.xmodel.manifest.enums.RqKeyboardType;
