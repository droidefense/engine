...
import apkr.external.module.datamodel.manifest.enums.*;
...
public enum ManifestID implements Serializable {
    ...
    public static String getJavaMethodName(Attributes attributes, int i, String data) {
        ...
        switch (methodName) {
            ...
            case "setPlatformBuildVersionCode":
                methodName = "setVersionCode";
                break;
            //platformBuildVersionName
            case "setPlatformBuildVersionName":
                methodName = "setVersionName";
                break;
        }
        return methodName;
    }
