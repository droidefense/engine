...
import apkr.external.module.datamodel.manifest.enums.ReqNavigation;
import apkr.external.module.datamodel.manifest.enums.ReqTouchScreen;
import apkr.external.module.datamodel.manifest.enums.RqKeyboardType;
