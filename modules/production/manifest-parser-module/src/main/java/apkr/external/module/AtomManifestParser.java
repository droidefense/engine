 ...
 */
public final class AtomManifestParser implements Serializable {
    ...
    public AtomManifestParser() {
        System.out.println("Running Atom-Manifest-Parser...");
    ...
    private void parserCode() throws IOException, SAXException, ParserConfigurationException {
