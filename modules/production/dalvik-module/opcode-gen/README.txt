...
* Implement/update the opcode in C in com/mterp/c/...
  * Verify new code by running with "dalvik.com.execution-mode = int:portable"
    or "-Xint:portable".

* Implement/update the instruction in assembly in com/mterp/{arm*,x86*}/...
...
* Implement/update the instruction in
  com/compiler/codegen/{arm,x86}/CodegenDriver.c.

* Rebuild the interpreter code. See the notes in com/mterp/ReadMe.txt for
  details.

* Look in the directory com/analysis at the files CodeVerify.c,
...
* Update the switch inside dvmCompilerMIR2LIR() in
  com/compiler/codegen/{arm,x86}/CodegenDriver.c. (There may be other
...
The Dalvik VM tests (in the com/tests directory) provide a convenient
